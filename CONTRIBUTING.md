...
**logger**, your time is valuable, and your contributions mean a lot to us.
...
- star :star: the [project](https://github.com/logger/logger)
- tweet your support for **logger**
...
- **version**: please note the version of **logger** are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of **logger** may close an issue at
...
[so]: http://stackoverflow.com/questions/tagged/logger
